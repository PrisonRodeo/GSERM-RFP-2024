...
% for my GSERM "Regression for Publishing" students 
% in 2024.
%
% Christopher Zorn
% June 22, 2024
...
\nin It's here because the space after \texttt{end{document}} can be a great spot to store code that you may not need in the document now, but will possibly want later.
